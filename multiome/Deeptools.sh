#!/bin/bash
#SBATCH --job-name=atac_peaks_genes_svg
...
#                             -R ../bedtools/hap1_mitr_v1.sorted.agat.bed \
...
#                             -R ../bedtools/atac_peaks.sorted.merged.bed \
