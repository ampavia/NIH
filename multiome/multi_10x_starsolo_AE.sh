#!/bin/bash
#SBATCH --job-name=KRT_multi_gex_starsolo	# Job name
...
################################################################################
LIB='KRT_AE'
WD='/scratch/ac05869/10X_Multiome/KRT_leaf/KRT_AE'
[ -d $WD ] || mkdir -p $WD
cd $WD
R1='/scratch/ac05869/10X_Multiome/KRT_leaf/KRT_AC_AE/gex_repaired/KRT_AE_S2_R1_001.fastq.gz'
R2='/scratch/ac05869/10X_Multiome/KRT_leaf/KRT_AC_AE/gex_repaired/KRT_AE_S2_R2_001.trim.fastq.gz'

ml STAR/2.7.10b-GCC-11.3.0

#STARsolo alignment
STAR --genomeDir /scratch/ac05869/10X_Multiome/KRT_leaf/mitr_v1/fasta \
--readFilesIn $R2 $R1
...
--soloCBwhitelist ../737K-arc-v1.txt.gz \
