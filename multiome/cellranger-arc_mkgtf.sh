...
#SBATCH --mem=20G			# How much memory per node, _required_
...
GFF='/scratch/ac05869/10X_Multiome/KRT_leaf/genome/mitr_v1.working_models.gff3'
cd $WD
...
cellranger-arc mkgtf $GTF mitr_v1.working_models.agat.filtered.gtf3 --attribute=gene_biotype:protein_coding