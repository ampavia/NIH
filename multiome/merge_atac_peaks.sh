...
##
##Using cellranger peaks mapped on haplotype 1, merge peaks
##

WD='/scratch/ac05869/10X_Multiome/KRT_leaf/ATAC_analysis_hap1/'
OUT='/scratch/ac05869/10X_Multiome/KRT_leaf/ATAC_analysis_hap1/bedtools'
...
#make bed file from gene gff3 haplotype 1
ml AGAT
agat_convert_sp_gff2bed.pl --gff $GFF -o $OUT/mitr_v1.agat.bed
awk '$1 ~ /_1$/' mitr_v1.agat.bed | sort -k1,1 -k2,2n > hap1_mitr_v1.sorted.agat.bed
