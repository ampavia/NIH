...
CONFIG='/scratch/ac05869/10X_Multiome/KRT_leaf/genome/config_both_hap.txt'
#GTF:/scratch/ac05869/10X_Multiome/KRT_leaf/genome/mitr_v1.working_models.agat.filtered.gtf3
#FASTA: /scratch/ac05869/10X_Multiome/KRT_leaf/genome/mitr_v1.asm.fa
cd $WD
ml CellRanger-ARC/2.0.2

cellranger-arc mkref --config=$CONFIG --nthreads=16 --memgb=128 --ref-version=2

#sbatch ~/NIH/multiome/CR_mkref_both_hap.sh