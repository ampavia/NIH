...
#SBATCH --output=/scratch/ac05869/%x_%j.out	# Standard output log
...
cellranger-arc count --id=${LIB}_both_hap \
 --reference=./genome/mitr_v1_both_hap \
 --libraries=./${LIB}/${LIB}.csv \
 --localcores=16 \
 --localmem=300
 
 #sbatch --array 1-2 --export=INFILE=/scratch/ac05869/10X_Multiome/KRT_leaf/multiome_ID.txt ~/NIH/multiome/cellranger-arc_count_both_hap.sh