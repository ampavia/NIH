...
WD='/scratch/ac05869/10X_Multiome'
GTF='/scratch/ac05869/10X_Multiome/KRT_leaf/mitr_v1/mitr_v1.working_models.repr.gtf'
GFF='/scratch/ac05869/10X_Multiome/KRT_leaf/mitr_v1/mitr_v1.working_models.repr.gff3'
CONFIG='/scratch/ac05869/10X_Multiome/KRT_leaf/mitr_v1/config.txt'
cd $WD
ml CellRanger-ARC/2.0.2
#ml AGAT/1.1.0
#agat_convert_sp_gff2gtf.pl --gff $GFF -o $GTF

cellranger-arc mkref --config=$CONFIG --nthreads=16 --memgb 128 --ref-version ref1