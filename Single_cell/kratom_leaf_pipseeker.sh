#!/bin/bash
#SBATCH --job-name=pipseeker_kratom_leaf		# Job name 
...
################################################################################
#Project: Kratom leaf pipseeker MIT_AH MIT_AI
...
mkdir /scratch/ac05869/nih/kratom/pipseeker/${LIB}
...
--chemistry V --output-path /scratch/ac05869/nih/kratom/pipseeker/${LIB}
