...
CPU=32
M50='/scratch/ac05869/gese_final_yahs/yahs/filter/gese_v1.org_50kb_filter.asm.yahs.fa'
...
>&2 echo"### Step 1.1: check stats and filter"
...
#seqkit seq -m 50000 -o $M50 -t dna -j $CPU $SCAF
#seqkit stats -a -o $STATS/50kb_filter_stats.txt -t dna -j $CPU $M50
#busco -i $M50 -m genome -l eudicotyledons_odb12 -c $CPU -o BUSCO_$(basename "$M50") --out_path $STATS
