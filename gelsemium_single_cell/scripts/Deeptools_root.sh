...
computeMatrix reference-point -S ${LIB}.bigwig \
                            -R ${BED}/GEL_root.atac_peaks.sorted.merged.bed \
...
#sbatch --array 1-2 --export=INFILE=/scratch/ac05869/gelsemium_sc/ROOT_multi_libraries.txt /scratch/ac05869/gelsemium_sc/scripts/Deeptools_root.sh