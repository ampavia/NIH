...
#SBATCH --mem=164G			# How much memory per node, _required_
...
cellranger-arc count --id=${LIB} \
 --reference=${WD}/gese_mpi_v2 \
 --libraries=../${LIB}.csv \
 --localcores=32 \
 --localmem=164
 
 #sbatch --array 1-4 --export=INFILE=/scratch/ac05869/gelsemium_sc/GEL_multi_libraries.txt /scratch/ac05869/gelsemium_sc/scripts/ATAC_2.sh
