#!/bin/bash
#SBATCH --job-name=GEL_EM		# Job name 
...
IN='/scratch/ac05869/gelsemium_sc/GEL/STAR'
...
#sbatch --array 1-4 --export=INFILE=/scratch/ac05869/gelsemium_sc/GEL_libraries.txt /scratch/ac05869/gelsemium_sc/scripts/GEL_STAR_EM.sh
