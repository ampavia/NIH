...
```{r}
saveRDS(AE_clean, file = "../Data/AE_clean_normalized.rds")
saveRDS(AF_clean, file = "../Data/AF_clean_normalized.rds")
...
pathway_genes <- read_delim("../Data/pathway_genes_allwins_and_cro_orthologs.tsv")
head(pathway_genes)
```
