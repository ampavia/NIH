#!/bin/bash
#SBATCH --job-name=yahs_bam_highermem		                    # Job name
...
bwa mem -t 12 ${FILES}/gese_v1.asm.fa ${FILES}/gel-an_1438200/gel-an_1438201_S3HiC_R1.fastq.gz ${FILES}/gel-an_1438200/gel-an_1438201_S3HiC_R2.fastq.gz | samtools sort -O BAM --threads 6 - > ${OUTDIR}/gel-an_1438201_S3HiC.sorted.bam
samtools index -@ 12 ${OUTDIR}/gel-an_1438201_S3HiC.sorted.bam
