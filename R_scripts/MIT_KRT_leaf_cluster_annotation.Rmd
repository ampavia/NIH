...
ggsave("/scratch/ac05869/MIT_KRT_sc_analysis/pathway_data/poster_KRT_MIT_leaf_whole_pathway_top_hit_28feb25.png", height = 10, width = 10, bg = "white")
```
...
ggsave("/scratch/ac05869/MIT_KRT_sc_analysis/pathway_data/poster2_KRT_MIT_leaf_whole_pathway_top_hit_28feb25.png", height = 10, width = 10, bg = "white")
```
