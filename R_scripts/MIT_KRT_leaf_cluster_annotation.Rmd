...
leaf_cell_type_assignment <- data.frame(
  ...
  mutate(cell_type = factor(cell_type, 
                            levels = c(
                              ...
                              "Xylem", "Phloem",
                              "Proliferating", "Mesophyll+MEP", "IPAP", "Unassigned"
                            ))) %>% 
...
```{r}
cros <- read.table("~/nih/kratom_pathway_orthologs_20mar25.txt", header = TRUE, sep = "\t")
...
ggsave("/scratch/ac05869/MIT_KRT_sc_analysis/pathway_data/poster_KRT_MIT_leaf_whole_pathway_orthologs_20ma25.png", height = 10, width = 10, bg = "white")
```
...
ggsave("/scratch/ac05869/MIT_KRT_sc_analysis/pathway_data/poster2_KRT_MIT_leaf_whole_pathway_ortholog_14mar25.png", height = 10, width = 10, bg = "white")
ggsave("/scratch/ac05869/MIT_KRT_sc_analysis/pathway_data/poster2_KRT_MIT_leaf_whole_pathway_ortholog_14mar25.svg", height = 10, width = 10, bg = "white")
```
