...
combined_markers_with_gff_anno <- inner_join(leaf.combined.markers, working_models2, by="gene") %>%
  left_join(anno, by = "gene", multiple = "first") %>%
  select(cluster, gene, functional_annotation, avg_log2FC, p_val_adj, pct.1, pct.2, chr, start, end, strand)
dim(combined_markers_with_gff_anno) #30175
head(combined_markers_with_gff_anno)
write.table(combined_markers_with_gff_anno, file = "/scratch/ac05869/MIT_KRT_sc_analysis/seurat_out/annotated_KRT_MIT_clean_integrated_all_markers_minpct0.25_minlfc0.25_28mar25.txt", row.names = FALSE, sep = "\t", quote = FALSE)
...
write.table(MPI_markers_with_gff_anno, file = "/scratch/ac05869/MIT_KRT_sc_analysis/seurat_out/annotated_KRT_MIT_clean_integrated_MPI_markers_minpct0.25_minlfc0.25_28mar25.txt", row.names = FALSE, sep = "\t", quote = FALSE)
...
write.table(UGA_markers_with_gff_anno, file = "/scratch/ac05869/MIT_KRT_sc_analysis/seurat_out/annotated_KRT_MIT_clean_integrated_UGA_markers_minpct0.25_minlfc0.25_28mar25.txt", row.names = FALSE, sep = "\t", quote = FALSE)
```
...
write.table(combined_markers_with_gff_anno, file = "/scratch/ac05869/MIT_KRT_sc_analysis/seurat_out/annotated_coexpression_KRT_MIT_clean_integrated_all_markers_minpct0.25_minlfc0.25_28mar25.txt", row.names = FALSE, sep = "\t", quote = FALSE)
...
write.table(MPI_markers_with_gff_anno, file = "/scratch/ac05869/MIT_KRT_sc_analysis/seurat_out/annotated_coexpression_KRT_MIT_clean_integrated_MPI_markers_minpct0.25_minlfc0.25_28mar25.txt", row.names = FALSE, sep = "\t", quote = FALSE)
...
write.table(UGA_markers_with_gff_anno, file = "/scratch/ac05869/MIT_KRT_sc_analysis/seurat_out/annotated_coexpression_KRT_MIT_clean_integrated_UGA_markers_minpct0.25_minlfc0.25_28mar25.txt", row.names = FALSE, sep = "\t", quote = FALSE)
