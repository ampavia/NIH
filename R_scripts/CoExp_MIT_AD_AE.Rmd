...
ggsave("/scratch/ac05869/nih/coexpression/kratom_stem/Results/r_histogram.svg", height = 3.5, width = 5, bg = "white")
ggsave("/scratch/ac05869/nih/coexpression/kratom_stem/Results/r_histogram.png", height = 3.5, width = 5, bg = "white")
```
...
```{r}
modules_mean_z <- modules_mean_z %>% 
  mutate(order_x = as.factor(cluster)) %>%  
...
module_peak_exp2 <- module_peak_exp %>% 
  mutate(order_y = as.factor(cluster)) %>%  
