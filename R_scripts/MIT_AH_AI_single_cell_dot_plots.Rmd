...
ggsave("/scratch/ac05869/nih/kratom/seurat_analysis/mpi_kratom_leaf_mitr.v1/MIT_AH_AI_new_allwin_pathway_top_several_hits.png", height = 10, width = 12, bg = "white")
```
