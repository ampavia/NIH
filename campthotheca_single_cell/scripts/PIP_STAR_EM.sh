#!/bin/bash
#SBATCH --job-name=STAR-em		# Job name 
...
IN='/scratch/ac05869/camptotheca_sc/STEM/STAR'
...
#sbatch --array 1-2 --export=INFILE=/scratch/ac05869/camptotheca_sc/pip_libs.txt /scratch/ac05869/camptotheca_sc/scripts/PIP_STAR_EM.sh
