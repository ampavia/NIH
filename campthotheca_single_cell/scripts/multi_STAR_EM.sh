#!/bin/bash
#SBATCH --job-name=STAR_EM10x		# Job name 
...
IN='/scratch/ac05869/camptotheca_sc/LEAF/STAR'
...
#sbatch --array 1-2 --export=INFILE=/scratch/ac05869/camptotheca_sc/10x_libs.txt /scratch/ac05869/camptotheca_sc/scripts/multi_STAR_EM.sh
