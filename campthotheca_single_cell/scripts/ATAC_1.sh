...
GFF='/work/crblab/ac05869/genomes/caac_v4_anno/export/caac_v4.working_models.gff3' #non repr models
GFF2='/scratch/ac05869/camptotheca_sc/genomes/caac_v4.working_models.agat.repr.gff3'
GTF='/scratch/ac05869/camptotheca_sc/genomes/caac_v4.working_models.agat.repr.gtf' #non repr
GTF2='caac_v4.working_models.agat.repr.CR_ARC.gtf'
CONFIG='/scratch/ac05869/camptotheca_sc/config.txt'
[ -d $WD ] || mkdir -p $WD 
...
#sbatch /scratch/ac05869/camptotheca_sc/scripts/ATAC_1.sh
