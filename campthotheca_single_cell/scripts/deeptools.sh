...
BED='/scratch/ac05869/camptotheca_sc/CR-ARC/merged_peaks'
WD='/scratch/ac05869/camptotheca_sc/CR-ARC/deeptools_out'
[ -d $WD ] || mkdir -p $WD 
cd $WD
...
computeMatrix scale-regions -S ${LIB}.bigwig \
                            -R ${BED}/caac_v4.working_models.agat.repr.sorted.bed \
...
computeMatrix reference-point -S ${LIB}.bigwig \
                            -R ${BED}/CAA_leaf.atac_peaks.sorted.merged.bed \
...
#sbatch --array 1-2 --export=INFILE=/scratch/ac05869/camptotheca_sc/multiome_libs.txt /scratch/ac05869/camptotheca_sc/scripts/deeptools.sh
