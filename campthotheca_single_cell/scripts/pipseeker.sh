...
################################################################################
#Project: camptotheca stem sc analysis
...
IN='/scratch/ac05869/camptotheca_sc/cDNA'
...
#Parameters 
#sbatch --array 1-2 --export=INFILE=/scratch/ac05869/camptotheca_sc/pip_libs.txt /scratch/ac05869/camptotheca_sc/scripts/pipseeker.sh
